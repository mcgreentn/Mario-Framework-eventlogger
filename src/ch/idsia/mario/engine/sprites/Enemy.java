    ...
    public void move()
    {
        ...
        if (deadTime > 0)
        {
            ...
            if (deadTime == 0)
            {
                ...
                //enemy fell off the map
                if(this.mapY >= this.world.level.height && this.mapX >= 0 && this.mapX <= this.world.level.width) {
            		LevelScene.killedCreaturesTotal += 1;
            		EventLogger.addToLogger("Enemy Fall Kill", world.mario.getMode(), world.mario.x, world.mario.y, world.getStartTime());
                }
            }
...
//                System.out.println("shellCollideCheck");
                EventLogger.addToLogger("Enemy Shell Kill", world.mario.getMode(), world.mario.x, world.mario.y, world.getStartTime());
                ++LevelScene.killedCreaturesTotal;
    ...
    public boolean fireballCollideCheck(Fireball fireball)
    {
        ...
        if (xD > -16 && xD < 16)
        {
            if (yD > -height && yD < fireball.height)
            {
                ...
                EventLogger.addToLogger("Enemy Fire Kill", world.mario.getMode(), world.mario.x, world.mario.y, world.getStartTime());
                ++LevelScene.killedCreaturesTotal;

...
//	System.out.println("Start");
	...
	// byte[][] scene =
	// observation.getCompleteObservation();//observation.getLevelSceneObservation(0);
...
//	System.out.println("*****Simulating " + sim.printAction(action));
...
//		System.out.println("##########Pre Action: " + sim.printAction(ac));
		return ac;
	    }
...
//	System.out.println("##########Selected Action: " + sim.printAction(action));
	return action;
    }
